  ...
  return (
    <Layout title="GeoGuessr" pageName="geoguessr">
      <Section id="geoguessr">
        ...
        <Paragraph>
          We're a fun club that primarily plays GeoGuessr, a game where you
          figure out where you are in the world from just a single image! We'll
          teach you all the tips and tricks that anyone from beginners to pros
          use to master the game. Additionally, inspired by our recent fizz
          fame, we're planning on teaching the basics of geolocation and OSINT
          techniques.
        </Paragraph>
        <Paragraph>
          Starting this year, ACM GeoGuessr Club is participating as Stanford
          University at the official Collegiate GeoGuessr League! We'll be
          participating in both solo and doubles in weekly tournaments.
        </Paragraph>
        <Paragraph>
        ...
        <GeoguessrImage
          src="/geoguessr/fizz_post.png"
          alt="GeoGuessr Fizz Post"
        />
      </Section>
      <Section id="board">
